...
\usetheme[pageofpages=of,% String used between the current page and the
          ...
          framepagelogo=logo, % logo for every page
...
\begin{frame}[t]
    \uncover<2>{\textbf{Where can version control help?}}
    ...
    \begin{columns}
        ...
        \end{column}
        \begin{column}{.23\linewidth}
            \only<2>{\setbeamercolor*{block body}{fg=black,bg=gitbodybg}}
            \begin{block}{}
                \begin{minipage}[t][\blockheight][t]{\linewidth}
                    \begin{enumerate}
...
\begin{frame}[t]
    ...
    \begin{columns}[T]
        ...
        \begin{column}{.58\linewidth}
            ...
            \begin{tikzpicture}
                \scriptsize
            \node [rectangle, text width=13mm, minimum height=8mm, draw=none, fill=red!50!black!50]
            at (0,6) {Working directory};
            \node [rectangle, text width=13mm, minimum height=8mm, draw=none, fill=orange!50!black!50]
            at (2.5,6) {Staging area};
            \node [rectangle, text width=13mm, minimum height=8mm, draw=none, fill=green!50!black!50]
            at (5,6) {Repository};
            \draw [ultra thick, draw=red!75!black] (0,1.63) -- (0,5.3);
            \draw [ultra thick, draw=orange!75!black] (2.5,1.63) -- (2.5,5.3);
            \draw [ultra thick, draw=green!75!black] (5,1.63) -- (5,5.3);
        \node[scalearrow,
              scalearrow width=8mm,
              minimum height = 25mm,
              rotate = 90,
          fill=red!50] at (1.25, 4.5) {};
          \node at (1.25,4.5) {add};
        \node[scalearrow,
              scalearrow width=8mm,
              minimum height = 25mm,
              rotate = 90,
          fill=green!50] at (3.75, 3.5) {};
          \node at (3.75,3.5) {commit};
        \node[scalearrow,
              scalearrow width=8mm,
              minimum height = 50mm,
              rotate = -90,
          fill=blue!50] at (2.5, 2.5) {};
          \node at (2.5,2.5) {checkout};
        \end{tikzpicture}
            \end{block}
        \end{column}
    \end{columns}
...
\begin{frame}[t]
    \frametitle{The power of git}
    \vspace{-2ex}
    \begin{columns}[T]
        \begin{column}{.57\linewidth}
            \begin{tikzpicture}
                % Branch names
                \uncover<4->{\node at (2,9) {\texttt{master}};}
                \uncover<7->{\node at (4,9) {\texttt{hollande}};}

                % Folder
                \node<1> at (0,8) {\includegraphics[width=10mm]{images/folder.png}};
                \node<2-> at (0,8) {\includegraphics[width=10mm]{images/folder_git.png}};
                \node<3-> at (1,8) {\huge\bf +};

                % master
                % m0
                \node<3> (m0t) [file,draw=black!40,very thick, left color=black!5,
                right color=white,minimum height=10mm,minimum width=8mm] at
                (2,8) {};
                \node<4-> (m0) [file,draw=black,very thick, left color=black!30,
                right color=white,minimum height=10mm,minimum width=8mm] at
                (2,8) {m0};
                % m1
                \node<5> (m1t) [file,draw=black!40,very thick, left color=black!5,
                right color=white,minimum height=10mm,minimum width=8mm] at
                (2,6.5) {};
                \node<6-> (m1) [file,draw=black,very thick, left color=black!30,
                right color=white,minimum height=10mm,minimum width=8mm] at
                (2,6.5) {m1};
                % m2
                \node<9-> (m2t) [file,draw=black!40,very thick, left color=black!5,
                right color=white,minimum height=10mm,minimum width=8mm] at
                (2,5) {};
                \node<12-> (m2) [file,draw=black,very thick, left color=black!30,
                right color=white,minimum height=10mm,minimum width=8mm] at
                (2,5) {m2};
                % m3
                \node<13-> (m3t) [file,draw=black!40,very thick, left color=black!5,
                right color=white,minimum height=10mm,minimum width=8mm] at
                (2,3.5) {};
                \node<14-> (m3) [file,draw=black,very thick, left color=black!30,
                right color=white,minimum height=10mm,minimum width=8mm] at
                (2,3.5) {m3};

                % hollande
                \node<7> (h1t) [file,draw=black!40,very thick, left color=black!5,
                right color=white,minimum height=10mm,minimum width=8mm] at
                (4,5.75) {};
                \node<8-> (h1) [file,draw=black,very thick, left color=black!30,
                right color=white,minimum height=10mm,minimum width=8mm] at
                (4,5.75) {h1};
                \node<10-> (h2t) [file,draw=black!40,very thick, left color=black!5,
                right color=white,minimum height=10mm,minimum width=8mm] at
                (4,4.25) {};
                \node<11-> (h2) [file,draw=black,very thick, left color=black!30,
                right color=white,minimum height=10mm,minimum width=8mm] at
                (4,4.25) {h2};
                \node<15-> [scalearrow,
                      scalearrow width=7mm,
                      minimum height = 9.5mm,
                      rotate = -90,
                      fill=red!50] at (4.9, 4.25) {};
                \node<15-> at (5.0, 4.25) {\scriptsize vFH1};
                % h3
                \node<16> (h3t) [file,draw=black!40,very thick, left color=black!5,
                right color=white,minimum height=10mm,minimum width=8mm] at
                (4,2.75) {};
                \node<17-> (h3) [file,draw=black,very thick, left color=black!30,
                right color=white,minimum height=10mm,minimum width=8mm] at
                (4,2.75) {h3};

                % paths master
                \path<6-> [line width=3pt, draw=blue!70!black] (m0) -- (m1);
                \path<12-> [line width=3pt, draw=blue!70!black] (m1) -- (m2);
                \path<14-> [line width=3pt, draw=blue!70!black] (m2) -- (m3);

                % paths hollande
                \path<7> [line width=3pt, draw=red!70!black] (m1) -- (h1t);
                \path<8-> [line width=3pt, draw=red!70!black] (m1) -- (h1);
                \path<11-> [line width=3pt, draw=red!70!black] (h1) -- (h2);
                \path<17-> [line width=3pt, draw=red!70!black] (h2) -- (h3);

                %merge
                \path<16-> [line width=3pt, draw=green!60!black!40, ->] (m3) --
                (h3t);
